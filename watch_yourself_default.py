...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        self.timerLabel = Label(self, font = ("Digital Dismay", 23), text = "28:00")
        self.timerLabel.pack(padx = 8, side = LEFT)

        self.firstButtonFrame = Frame(self)
        self.sevenButton = Radiobutton(self.firstButtonFrame, indicatoron = 0, font = ("Arial", 7, "bold"), text = "7", value = "7", width = "5", variable = self.timerVariable, command = self.STARTClock)
        self.sevenButton.pack(side = LEFT)
        self.fourteenkButton = Radiobutton(self.firstButtonFrame, indicatoron = 0, font = ("Arial", 7, "bold"), text = "14", value = "14", width = "5", variable = self.timerVariable, command = self.STARTClock)
        self.fourteenkButton.pack(side = LEFT)
        self.twentyoneButton = Radiobutton(self.firstButtonFrame, indicatoron = 0, font = ("Arial", 7, "bold"), text = "21", value = "21", width = "5", variable = self.timerVariable, command = self.STARTClock)
        self.twentyoneButton.pack(side = LEFT)
        self.firstButtonFrame.pack(side = TOP)

        self.secondButtonFrame = Frame(self)
        self.STARTButton = Button(self.secondButtonFrame, font = ("Arial", 7, "bold"), text = "START", width = "5", command = self.STARTTime)
        self.STARTButton.pack(side = LEFT)
        self.STOPButton = Button(self.secondButtonFrame, font = ("Arial", 7, "bold"), text = "STOP", width = "5", command = self.STOPTime)
        self.STOPButton.pack(side = LEFT)
        self.RESETButton = Button(self.secondButtonFrame, font = ("Arial", 7, "bold"), text = "RESET", width = "5", command = self.RESETTime)
